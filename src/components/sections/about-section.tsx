      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid gap-6 md:grid-cols-2 md:gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              <p className="text-sm leading-relaxed text-foreground/90 md:max-w-md md:text-lg">
              ...
              <p className="hidden text-sm leading-relaxed text-foreground/90 sm:block md:max-w-md md:text-lg">
        ...
        <div
          className={`mt-6 flex flex-wrap gap-2 transition-all duration-700 sm:gap-3 md:mt-16 md:gap-4 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"
          }`}
